...
Mappings are processed in ascending order, firt to match serves. To ensure all
packages can be served by at least one package, the last on should be a match 
all (*).
