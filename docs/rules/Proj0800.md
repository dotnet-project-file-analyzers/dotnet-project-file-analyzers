...
Hence, this rule advises to enable Central Package Management by
enabling it in the `Directory.Packages.props` file:
...
## Converting
If you want to convert your large project to use CPM then you might want to use
