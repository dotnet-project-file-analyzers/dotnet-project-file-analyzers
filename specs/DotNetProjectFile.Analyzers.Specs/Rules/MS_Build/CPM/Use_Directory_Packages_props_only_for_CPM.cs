...
public class Reports
{
    ...
    public void bloated_Directory_Packages_Props()
        ...
        .HasIssues(
            new Issue("Proj0807", "As <TargetFramework> is not about Central Package Management it should not be in Directory.Packages.props." /*..*/).WithSpan(05, 04, 05, 53),
            new Issue("Proj0807", "As <OutputType> is not about Central Package Management it should not be in Directory.Packages.props." /*.......*/).WithSpan(06, 04, 06, 36),
