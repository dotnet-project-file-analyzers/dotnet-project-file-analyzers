...
public class Reports
{
    ...
    public void assets_as_elements()
        ...
        .HasIssues(
            new Issue("Proj0005", "Define package reference assets of 'BackwardsCompatibleFeatures' as attributes.").WithSpan(08, 04, 10, 23),
            new Issue("Proj0005", "Define package reference assets of 'SonarAnalyzer.CSharp' as attributes." /*..*/).WithSpan(11, 04, 14, 23));
}
