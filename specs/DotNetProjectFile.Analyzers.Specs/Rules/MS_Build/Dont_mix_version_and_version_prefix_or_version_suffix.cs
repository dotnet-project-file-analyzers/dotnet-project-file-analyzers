...
public class Reports
{
    ...
    public void on_version_and_prefix()
       => new DontMixVersionAndVersionPrefixOrVersionSuffix()
        ...
        .HasIssue(
           new Issue("Proj0245", "Remove the <Version> node or remove the <VersionPrefix> node.")
    ...
    public void on_version_and_suffix()
       => new DontMixVersionAndVersionPrefixOrVersionSuffix()
        ...
        .HasIssue(
           new Issue("Proj0245", "Remove the <Version> node or remove the <VersionSuffix> node.")
           .WithSpan(09, 04, 09, 28));
    ...
    public void on_version_and_prefix_and_suffix()
       => new DontMixVersionAndVersionPrefixOrVersionSuffix()
        ...
        .HasIssue(
           new Issue("Proj0245", "Remove the <Version> node or remove the <VersionPrefix> and <VersionSuffix> nodes.")
           .WithSpan(09, 04, 09, 28));
}
