...
public class Reports
{
    ...
    public void private_assets_not_being_private()
        ...
        .HasIssues(
            new Issue("Proj1200", @"Mark the package reference ""coverlet.collector"" as a private asset.").WithSpan(16, 05, 16, 69),
            new Issue("Proj1200", @"Mark the package reference ""NUnit.Analyzers"" as a private asset.").WithSpan(17, 05, 17, 147));
}
