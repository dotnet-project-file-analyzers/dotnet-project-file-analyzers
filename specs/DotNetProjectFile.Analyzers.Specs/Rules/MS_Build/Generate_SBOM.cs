...
public class Reports
{
    ...
    public void on_missing_property() => new GenerateSbom()
        ...
        .HasIssue(new Issue("Proj0243", "Enable SBOM generation with <GenerateSBOM> is 'true' or define the <IsPackable> node with value 'false'.")
    ...
    public void on_missing_reference() => new GenerateSbom()
        ...
        .HasIssue(new Issue("Proj0243", "Register the NuGet package 'Microsoft.Sbom.Targets' or define the <IsPackable> node with value 'false'.")
