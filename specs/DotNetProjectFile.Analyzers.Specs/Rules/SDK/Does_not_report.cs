...
public class On 
{
    ...
    public void Project_not_available_as_additional() => new AddAdditionalFile()
        .ForSDkProject("DotnetProjectFilesSdk")
        .HasIssues(
            new Issue("Proj0006", "Add 'DotNetProjectFile.Analyzers.Sdk.props' to the additional files."),
            new Issue("Proj0006", "Add 'DotNetProjectFile.Analyzers.Sdk.targets' to the additional files."));
