...
public sealed class ExcludePrivateAssetDependencies : MsBuildProjectFileAnalyzer
{
    public ExcludePrivateAssetDependencies() : base(Rule.ExcludePrivateAssetDependencies) { }
