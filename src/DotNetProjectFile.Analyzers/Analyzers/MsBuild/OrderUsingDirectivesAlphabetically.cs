...
public sealed class OrderUsingDirectivesAlphabetically : MsBuildProjectFileAnalyzer
{
    public OrderUsingDirectivesAlphabetically() : base(Rule.OrderUsingDirectivesAlphabetically) { }
