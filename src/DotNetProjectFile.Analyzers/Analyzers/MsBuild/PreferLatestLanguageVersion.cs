...
public sealed class PreferLatestLanguageVersion() : MsBuildProjectFileAnalyzer(Rule.PreferLatestLanguageVersion)
{
    ...
    public override ImmutableArray<Language> ApplicableLanguages { get; } = [Language.CSharp, Language.VisualBasic];
    ...
    protected override void Register(ProjectFileAnalysisContext<MsBuildProject> context)
    {
        ...
        var advised = context.CompilationLanguage == Language.CSharp
            ? CSharp(sdkVersion)
            : VisualBasic(sdkVersion);
