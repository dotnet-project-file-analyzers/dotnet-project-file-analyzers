...
/// <summary>Specifies the location of mscorlib.dll and microsoft.visualbasic.dll. This parameter is equivalent to the /sdkpath switch of the vbc.exe compiler.</summary>
/// <remarks>Visual Basic only.</remarks>
internal sealed class FrameworkPathOverride(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }
...
/// <remarks>Visual Basic only.</remarks>
internal sealed class NoVBRuntimeReference(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }
...
/// <summary>Specifies how string comparisons are made. Valid values are "binary" or "text." This property is equivalent to the /optioncompare compiler switch of vbc.exe.</summary>
/// <remarks>VisualBasic</remarks>
internal sealed class OptionCompare(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }

/// <summary>A boolean value that when set to true, requires explicit declaration of variables in the source code. This property is equivalent to the /optionexplicit compiler switch.</summary>
/// <remarks>Visual Basic only.</remarks>
internal sealed class OptionExplicit(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }

/// <summary>A boolean value that when set to true, enables type inference of variables. This property is equivalent to the /optioninfer compiler switch.</summary>
/// <remarks>Visual Basic only.</remarks>
internal sealed class OptionInfer(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }

/// <summary>A boolean value that when set to true, causes the build task to enforce strict type semantics to restrict implicit type conversions. This property is equivalent to the /optionstrict switch of the vbc.exe compiler.</summary>
/// <remarks>Visual Basic only.</remarks>
internal sealed class OptionStrict(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }
...
/// <remarks>Visual Basic only.</remarks>
internal sealed class VbcToolPath(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }
...
/// <remarks>Visual Basic only.</remarks>
internal sealed class VbcVerbosity(XElement element, Node? parent, MsBuildProject? project) : Node<bool?>(element, parent, project) { }
